...
## Initial .nii files
nii_regex_path = '/neurospin/psy_sbox/CoRR/derivatives/cat12-12.6_vbm/sub-*/ses-*/anat/mri/mwp1*.nii'
## Phenotype obtained with <phenotypes_make_dataset.py>
phenotype_path = '/neurospin/psy_sbox/CoRR/CoRR_t1mri_mwp1_participants.csv'
