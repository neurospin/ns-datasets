...
dataset = 'gsp'
## Initial .nii files
nii_regex_path = '/neurospin/psy_sbox/'+dataset.upper()+'/derivatives/cat12-12.6_vbm/sub-*/ses-*/anat/mri/mwp1*.nii'
## Phenotype obtained with <phenotypes_make_dataset.py>
phenotype_path = '/neurospin/psy_sbox/{dataset}/{dataset_u}_t1mri_mwp1_participants.csv'.format(dataset=dataset.upper(),
